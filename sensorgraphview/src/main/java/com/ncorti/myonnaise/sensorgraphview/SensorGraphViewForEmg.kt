...
private const val INITIAL_MAX_VALUE = 150.0f
private const val INITIAL_MIN_VALUE = -150.0f

class SensorGraphViewForEmg(context: Context, attrs: AttributeSet) : View(context, attrs) {
